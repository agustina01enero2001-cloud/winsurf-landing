const messages = [
  {
    ...
    amount: "$100.000",
    badge: "Comprobante verificado",
    replies: ["Perfecto, ya está acreditado 🔥", "Vamos por más 🏆"],
  },
  {
    time: "20:11",
    user: "Usuario Winsurf",
    text: "Primera carga realizada",
    amount: "$150.000",
    badge: "Beneficio activo",
    replies: ["Excelente, beneficio activado ✅", "Gracias por confiar."],
  },
  {
    time: "21:06",
